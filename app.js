/**
 * APP.JS - ELITE IVY LEAGUE MASTER FIX (v10.0 - PURE JSON & LISTENING INTEGRATION)
 ...
 * - Tích hợp Web Speech API cho bài tập Listening.
 */
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function displayQuestion() {
        ...
        // Ngắt âm thanh AI khi chuyển câu
    ...
    function speakText(text) {
        if (!('speechSynthesis' in window)) {
            alert("Trình duyệt của bạn không hỗ trợ tính năng đọc AI. Hãy thử dùng Chrome hoặc Safari bản mới nhất.");
            return;
        }
